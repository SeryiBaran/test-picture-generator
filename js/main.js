...
var use_bresenham_algorithms = $("#use_bresenham_algorithms_check").is(":checked");
...
var enable_antialiasing_disable_filter = $("#enable_antialiasing_disable_filter_check").is(":checked");
...
function generatePattern(workspace, width_prop, height_prop) {
	var width = Number(width_prop);
	var height = Number(height_prop);
	workspace.empty();
